...
- [ ] Relevant **FS abuse cases** (money movement, fraud at scale, market abuse, data exfiltration) walked; owner **Chapter 4**. *Done when:* each applicable abuse case is recorded in-scope or ruled out with a reason.
