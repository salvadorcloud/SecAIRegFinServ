# Checklist 4: Governance and assurance (Part V)

Run this at the governance forum that owns AI risk. It closes the loop from operating model to board reporting.

- [ ] The **AI governance operating model** assigns ownership, decision rights, and escalation for AI risk; owner **Chapter 13**. *Done when:* a named owner, decision rights, and an escalation route are documented for AI risk.
- [ ] Each AI use case carries a **firm-internal AI risk tier** that drives control depth; owner **Chapter 13**. *Done when:* every live use case has an assigned tier and the tier visibly sets its control depth.
- [ ] Generative and agentic systems brought under **model risk management as a control**, adapted for genAI; owner **Chapter 14**. *Done when:* each genAI system is registered in MRM under the adapted regime.
