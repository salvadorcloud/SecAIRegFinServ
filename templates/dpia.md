...
*Owner: Chapter 9 (AI data protection) · obligations owned in Part VI (Chapter 24, GDPR). Not a substitute for your DPO's process.*

## 0. Is a DPIA required? (screening: confirm with your DPO)
Article 35 (obligation owned in Chapter 24) makes a DPIA mandatory for high-risk processing, not merely advisable. Screen first; if any indicator applies, treat a DPIA as required:
...
- [ ] Automated decisions with legal or similarly significant effect (route to Chapter 24)
...
- Lawful basis (confirm with DPO; obligation owned in Chapter 24):
...
- Automated decision-making considerations (route to Chapter 24):
